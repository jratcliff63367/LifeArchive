    ...
    for src in SOURCES:
        ...
        for root, _, files in os.walk(src):
            for f in files:
                ...
                # Metadata extraction
                # IMPORTANT: pass the full archive-relative path context (including
                # the source base) into resolve_file_date(). This preserves the
                # intended 'undated anywhere in the hierarchy' override, even when
                # the marker lives in the source root itself, e.g. 'Topaz-Undated'.
