...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .places-gallery-card { background: rgba(0,0,0,0.18); border:1px solid #2f2f2f; border-radius: 14px; overflow:hidden; }
                ...
                <div class="places-gallery">
                    ...
                    <div class="places-gallery-card">
                        ...
                        <div class="places-gallery-meta">
                            <div class="places-gallery-title">{{ p._month_name if p._month_name is defined else 'Photo' }}{% if p._year is defined %} {{ p._year }}{% endif %}</div>
                        </div>
                    </div>
                    {% endfor %}
                </div>
